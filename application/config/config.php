...
if (defined('URL_SUB_FOLDER')) {
    ...
    define('IMG', URL_PROTOCOL . URL_DOMAIN . '/' . URL_SUB_FOLDER . '/public/img/');
    define('AUD', URL_PROTOCOL . URL_DOMAIN . '/' . URL_SUB_FOLDER . '/public/audio/');
    define('URL_WITH_INDEX_FILE', URL_PROTOCOL . URL_DOMAIN . '/' . URL_SUB_FOLDER . '/' . URL_INDEX_FILE);
} else {
    define('URL', URL_PROTOCOL . URL_DOMAIN . '/');
    define('IMG', URL_PROTOCOL . URL_DOMAIN . '/public/img/');
    define('AUD', URL_PROTOCOL . URL_DOMAIN . '/public/audio/');
